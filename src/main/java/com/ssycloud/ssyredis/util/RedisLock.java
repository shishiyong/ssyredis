package com.ssycloud.ssyredis.util;
...
public class RedisLock {
    ...
    public boolean lock(String targetId,String timeStamp){
        ...
        if(!Strings.isEmpty(currentLock) && Long.parseLong(currentLock) < System.currentTimeMillis()){
            ...
            if(!Strings.isEmpty(preLock) && preLock.equals(currentLock) ){
    ...
    public void unlock(String target,String timeStamp){
        try {
            ...
            if(!Strings.isEmpty(currentValue) && currentValue.equals(timeStamp) ){
                // 删除锁状态
